DROP VIEW "public"."v_contributions";--> statement-breakpoint
ALTER TABLE "auth"."user" ADD COLUMN "is_anonymous" boolean DEFAULT false NOT NULL;--> statement-breakpoint

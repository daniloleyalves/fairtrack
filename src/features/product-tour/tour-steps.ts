...
export const TOUR_TIME_SCALE = 0.75;

export const tourTime = (seconds: number) => seconds * TOUR_TIME_SCALE;
    ...
    steps: [
      {
        ...
        cursor: {
          ...
          ys: [700, 430, 428, 428, 590, 590],
          times: [0, 1.1, 2.0, 3.2, 4.3, 5],
        },
    ...
    steps: [
      ...
      },
      {
        ...
        cursor: {
          ...
          times: [0, 1.3, 2.5, 3.6, 4.5, 5.2, 5.8, 6.4, 7.2, 7.7],
        },
        clicks: [
          { x: 1840, y: 107, t: 1.5 },
          { x: 1845, y: 180, t: 2.7 },
      ...
      },
      {
        ...
        cursor: {
          xs: [2650, 3600, 3750, 3750, 3768, 3768, 3400, 3400],
          ys: [374, 420, 561, 561, 202, 202, 156, 156],
          times: [0, 1.6, 3.0, 4.4, 5.2, 7.3, 8.1, 8.5],
        },
        clicks: [
          { x: 3768, y: 202, t: 5.4 },
          { x: 3400, y: 156, t: 8.2 },
